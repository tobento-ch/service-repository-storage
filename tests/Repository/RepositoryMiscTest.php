...
use Tobento\Service\Repository\Storage\Test\Mock\ProductRepositoryWithColumns;
 ...
 * RepositoryMiscTest
 */
class RepositoryMiscTest extends TestCase
{
    ...
    {
        $repository = new ProductRepositoryWithColumns(
            storage: new InMemoryStorage(
                items: $this->getStorageItems(),
            ),
            table: 'products',
